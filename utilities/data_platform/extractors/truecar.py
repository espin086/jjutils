...
os.system('gsutil -m  cp ../data/truecar/* gs://jj-projects-bucket/cruisin64/truecar/raw/')
os.system('rm ../data/truecar/*')


#consolidating and deplicating raw csv into a master csv
os.system('gsutil -m cp gs://jj-projects-bucket/cruisin64/truecar/raw/* ../data/truecar/')
...
os.system('gsutil -m cp ../data/truecar/clean/truecar.csv gs://jj-projects-bucket/cruisin64/truecar/clean/')
...
if day_of_week == 4 and hour_of_day == 6:
    email_util.send_email(subject = 'AUTOMATED EMAIL: {0} Hondas Scraped from Truecar'.format(num_of_cars), 
