...
if __name__ == '__main__':
    ...
    input_file = 'agents_with_duplicates.csv'
    output_file = 'agents_with_no_duplicates.csv'
    ...
    if os.path.exists(settings_file):
        ...
        fields = [
            ...
            {'field': 'LIST_AGENT_EMAIL', 'type': 'Exact', 'has missing': True},
            {'field': 'LIST_AGENT_PREFERRED_PHONE', 'type': 'String', 'has missing': True},
            ]
    ...
    # pp.pprint(cluster_membership)
    with open('cluster_membership.json', 'w', encoding='utf-8') as f:
