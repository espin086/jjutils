...
"""
This module scrapes listing from zillow of houses for sale
...
#get_ipython().run_cell_magic(u'bash', u'', u"jupyter nbconvert --to script zillow_scraper.ipynb\nsed -i '/get_ipython()/d' ./infile")
...
#get_ipython().run_cell_magic(u'bash', u'', u'python2 zillow_scraper.py')
